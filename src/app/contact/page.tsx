    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24 grid md:grid-cols-2 gap-10">
        ...
        >
          ...
          <div className="flex items-start gap-4">
            <Phone className="text-emerald-600 shrink-0" size={22} />
            <div>
          ...
          <div className="flex items-start gap-4">
            <Mail className="text-emerald-600 shrink-0" size={22} />
            <div>
          ...
          <div className="flex items-start gap-4">
            <Clock className="text-emerald-600 shrink-0" size={22} />
            <div>
        ...
        >
          {submitted ? (
            <motion.div
              ...
              className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 text-emerald-800"
            >
